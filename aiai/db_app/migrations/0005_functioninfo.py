...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('db_app', '0004_alter_agentrunlog_success'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['name'], name='db_app_func_name_d9012f_idx'), models.Index(fields=['file_path'], name='db_app_func_file_pa_06efa8_idx')],
