...
def _optimization_run(
    ...
    *,
    ...
    from aiai.synthesizer.evals import SyntheticEvalRunner
...
def main() -> None:  # noqa: C901 – the CLI can be a bit long
    ...
    if choice == 1:
        ...
        entrypoint = Path(__file__).resolve().parent / "examples" / "crewai" / "entrypoint.py"
    elif choice == 2:
    ...
    try:
        ...
        from aiai.synthesizer.evals import EvalGenerator

        generator = EvalGenerator()
        rules_eval, head_to_head_eval = generator.perform(list(FunctionInfo.objects.all()))
...
if __name__ == "__main__":
    # When running `python -m aiai.main` directly.
    main()
