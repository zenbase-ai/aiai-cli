# Generated by Django 5.2 on 2025-04-22 23:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trace_id', models.TextField(db_index=True)),
                ('span_id', models.TextField(db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('rules', 'Rules'), ('head_to_head', 'Head To Head')], max_length=20)),
                ('prompt', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['name'], name='app_functio_name_877854_idx'), models.Index(fields=['file_path'], name='app_functio_file_pa_12a69d_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eval', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.syntheticeval')),
            ],
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['is_valid_reference'], name='app_datafil_is_vali_a57352_idx'), models.Index(fields=['content_category'], name='app_datafil_content_473bd0_idx')],
            },
        ),
        migrations.AddIndex(
