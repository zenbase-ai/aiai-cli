...
class DependencyGraph:
    ...
    def _generate_markdown_visualization(self, output_path: Optional[str] = None) -> Optional[str]:
        ...
        function_id_map = {self.get_function_id(func): func for func_id, func in self.functions.items()}
        ...
        root_functions = [func for func_id, func in self.functions.items() 
        ...
        leaf_functions = [func for func_id, func in self.functions.items() 
