...
def test_analyzer_basic_functionality(sample_file, output_dir):
    ...
    expected_functions = {
        "main", "get_data", "process_data", "transform_item", 
        "calculate_result", "apply_bonus", "display_result", "format_for_report"
    }
    ...
    assert main_callees == {"get_data", "process_data", "calculate_result", "display_result"}, \
